        ...
        <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
            ...
            <div className='w-full lg:w-1/4 bg-white px-4'>
                ...
                <div className={showFilter ? "" : "max-lg:hidden"}>
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-4 text-gray-600">
            ...
            {/* Job Listing */}
            <section className='w-full lg_w-3/4 text-gray-800 max-lg:px-4'>
                <h3 className='font-meidum text-3xl py-2' id='job-list'>Latest Jobs</h3>
                ...
                {filteredJobs.length > 0 && (
                    <div className='flex items-center justify-center space-x-2 mt-10'>
                        ...
                        {Array.from({ length: Math.ceil(filteredJobs.length / 6) }).map((_, index) => (
                            <a href='#job-list' key={`page-${index}`}>
                                <button
